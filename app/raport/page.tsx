        ...
        <div style={{ background:'white', border:'0.5px solid #e5e7eb', borderRadius:'12px', overflow:'hidden', marginBottom:'14px' }}>
          ...
          <div style={{ padding:'20px' }}>
            <div style={g2}>
              ...
              <div><label style={lbl}>Medic</label><input value={medic} onChange={e => setMedic(e.target.value)}  style={inpDinamic(medic)} /></div>
            </div>
            <div style={g2}>
              <div><label style={lbl}>Specialitate</label><input value={specialitate} onChange={e => setSpecialitate(e.target.value)}  style={inpDinamic(specialitate)} /></div>
              <div><label style={lbl}>Clinică / Spital</label><input value={unitate} onChange={e => setUnitate(e.target.value)}  style={inpDinamic(unitate)} /></div>
            </div>
            <div><label style={lbl}>Diagnostic</label><input value={diagnostic} onChange={e => setDiagnostic(e.target.value)}  style={inpDinamic(diagnostic)} /></div>
          </div>
        </div>
