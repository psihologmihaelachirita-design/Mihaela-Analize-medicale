...
export default function Dashboard() {
  ...
  function ListaAnalize({ lista }: { lista: any[] }) {
    return (
      <div>
        <div style={{ display:'grid', gridTemplateColumns:'1fr 80px 80px 100px', gap:'8px', padding:'8px 20px', borderBottom:'0.5px solid #e5e7eb', background:'#f8f9fa' }}>
        ...
        {lista.map((a, i) => (
          <div key={i} style={{ display:'grid', gridTemplateColumns:'1fr 80px 80px 100px', gap:'8px', padding:'10px 20px', borderBottom:'0.5px solid #f5f5f5', alignItems:'center' }}>
