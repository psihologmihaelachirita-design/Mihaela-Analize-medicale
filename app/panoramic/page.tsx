                ...
                return (
                  <tr key={nume} style={{borderBottom:'0.5px solid #f0f0f0'}}>
                    ...
                    {toateDatele.map(data => {
                      ...
                      return (
                        <td key={data} style={{padding:'2px'}}>width:LABEL_WIDTH, fontSize:'11px', color:'#222', textAlign:'left', paddingLeft:'10px', whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis', verticalAlign:'middle', position:'sticky', left:0, zIndex:1, background:'white', borderRight:'0.5px solid #e5e7eb'
                          <div
