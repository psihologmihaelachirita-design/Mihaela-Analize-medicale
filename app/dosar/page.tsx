  ...
  return (
    <div style={{ fontFamily:'system-ui,-apple-system,sans-serif', background:'#f8f9fa', minHeight:'100vh' }}>
      ...
      <div style={{ maxWidth:'960px', margin:'0 auto', padding:'28px 24px' }}>
        ...
        {/* 4 CASETE – stil identic cu dashboard */}
        ...
        <div style={{ display:'flex', flexWrap:'wrap', gap:'10px', alignItems:'center', marginBottom:'16px', background:'white', padding:'12px 16px', borderRadius:'12px', border:'0.5px solid #e5e7eb' }}>
          <div style={{ flex:1, minWidth:'180px', display:'flex', alignItems:'center', gap:'8px', background:'#f8f9fa', padding:'4px 12px', borderRadius:'8px', border:'0.5px solid #e5e7eb' }}>
            ...
            <input
              ...
              style={{ width:'100%', padding:'8px 4px', border:'none', background:'transparent', fontSize:'13px', outline:'none', color:'#111' }}
            />
          </div>
          <select
        ...
        {/* TABEL – stil identic cu dashboard */}
