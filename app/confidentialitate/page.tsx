    ...
    <div style={{ fontFamily:'system-ui,-apple-system,sans-serif', background:'#f8f9fa', minHeight:'100vh' }}>
      ...
      <div style={{ maxWidth:'720px', margin:'0 auto', padding:'48px 24px' }}>
        ...
        <div id="gdpr" style={{ marginBottom:'48px' }}>
          ...
          <p style={{ fontSize:'14px', color:'#333', lineHeight:1.8 }}>
            Pentru orice solicitare legată de datele tale, ne poți contacta la <a href="mailto:psihologmihaelachirita@gmail.com" style={{ color:'#16705a' }}>psihologmihaelachirita@gmail.com</a>.
          </p>
        </div>
