...
IMPORTANT: Pentru campul "nume" foloseste OBLIGATORIU unul din numele standardizate de mai jos. Alege cel mai potrivit nume standardizat pentru fiecare analiza din document, indiferent cum e scrisa in document (cu diacritice, fara, abrevieri, variante). Daca nu gasesti un nume standardizat potrivit, foloseste numele exact din document.

NUME STANDARDIZATE PERMISE:
