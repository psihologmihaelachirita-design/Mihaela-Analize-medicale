...
'pth intact (parathormon) - ser': 'PTH intact',
  'cortizol': 'Cortizol',
  'dhea-s': 'DHEA-S',
  'dhea': 'DHEA-S',
...
const INTERVALE_STANDARD: Record<string, [number | null, number | null, string]> = {
  ...
  'Cupru': [70, 140, 'µg/dL'],
  'IgA': [70, 400, 'mg/dL'],
  'IgA secretor (materii fecale)': [510, 2040, 'µg/mL'],
  'Amilaza pancreatica': [13, 53, 'U/L'],
  'Complement C3': [90, 180, 'mg/dL'],
  'Complement C4': [16, 47, 'mg/dL'],
  'Factor reumatoid (FR)': [0, 14, 'UI/mL'],
  'Anti-CCP': [0, 17, 'U/mL'],
  'Granulocite imature %': [0, 0.5, '%'],
  'Granulocite imature absolute': [0, 0.03, 'x10³/µL'],
  'Indice productie reticulocitara': [1, 2, ''],
  'Tiroglobulina': [0, 55, 'ng/mL'],
  'IgG': [700, 1600, 'mg/dL'],
  'IgM': [40, 230, 'mg/dL'],
      ...
      body: JSON.stringify({
        ...
        messages: [{
          ...
          content: [
            ...
            {
              type: 'text',
              text: `Extrage TOATE analizele din acest document medical PDF. 

IMPORTANT: Pentru campul "nume" extrage EXACT textul asa cum apare in documentul PDF, fara sa il modifici, traduca sau normalizezi. Pastreaza denumirea originala din document inclusiv diacritice, abrevieri si paranteze.


Eritrocite, Hemoglobina, Hematocrit, Volum eritrocitar mediu (VEM), Hemoglobina eritrocitara medie (HEM), Concentratie medie Hb/eritrocit (CHEM), Largimea distributiei eritrocitare (RDW), Leucocite, Neutrofile %, Neutrofile absolute, Limfocite %, Limfocite absolute, Monocite %, Monocite absolute, Eozinofile %, Eozinofile absolute, Bazofile %, Bazofile absolute, Trombocite, Volum trombocitar mediu (VTM), Largimea distributiei trombocitare (PDW), Reticulocite %, Reticulocite absolute, VSH, Timp de protrombina (TP), INR, Activitate protrombina %, aPTT, Fibrinogen, D-Dimeri, Glucoza, Hemoglobina glicata (HbA1c), Insulina, HOMA-IR, Colesterol total, Colesterol HDL, Colesterol LDL, Trigliceride, ALT (TGP), AST (TGO), GGT, Fosfataza alcalina, Bilirubina totala, Bilirubina directa, Bilirubina indirecta, Proteine totale, Albumina, Creatinina, eGFR, Uree, Acid uric, Sodiu, Potasiu, Calciu, Calciu ionic, Magneziu, Fosfor, Fier seric, Feritina, Transferina, TIBC, Amilaza, Lipaza, Proteina C reactiva (CRP), Homocisteina, TSH, T3 total, FT3, T4 total, FT4, Anti-TPO, Anti-tiroglobulina, Tiroglobulina, PTH intact, Cortizol, DHEA-S, Vitamina D (25-OH), FSH, LH, Estradiol (E2), Progesteron, Prolactina, Testosteron total, Testosteron liber, AMH, Beta-HCG, Vitamina B12, Acid folic (B9), Zinc, Seleniu, Cupru, IgA, IgG, IgM, IgE total, ANA, Factor reumatoid (FR), Anti-CCP, HBsAg (Hepatita B), Anti-HBs (Hepatita B), Anti-HCV (Hepatita C), Anti-HIV, EBV VCA IgG, EBV VCA IgM, CMV IgG, CMV IgM, Toxoplasma IgG, Toxoplasma IgM, PSA total, PSA liber, CEA, AFP, CA 125, CA 19-9, CA 15-3, Troponina I, BNP, NT-proBNP, CK-MB, Ag Streptococ grup A, Sumar urina, Microalbuminurie, Examen coproparazitologic

Pentru analize cu valoare numerica foloseste tip_rezultat "numeric". Pentru analize cu rezultat text (negativ/pozitiv/prezent/absent/reactiv/neractiv) foloseste tip_rezultat "calitativ" si pune rezultatul in rezultat_text. Extrage si orasul si tara laboratorului daca sunt mentionate. Returneaza STRICT JSON valid fara text suplimentar:
{"analize":[{"nume":"numele analizei exact cum apare in documentul PDF","valoare":"valoarea numerica sau null","unitate":"unitatea de masura sau null","referinta_min_lab":"valoarea minima de referinta pentru ADULTI (18+ ani) din documentul laboratorului sau null. Daca referinta are forma '< X' atunci referinta_min_lab = 0 si referinta_max_lab = X. Daca referinta are forma '> X' atunci referinta_min_lab = X si referinta_max_lab = null. IMPORTANT: daca exista mai multe intervale pe varste (copii, adolescenti, adulti), ia OBLIGATORIU doar intervalul pentru Adulti 18+ ani. Ignora complet intervalele pentru copii si adolescenti","referinta_max_lab":"valoarea maxima de referinta pentru ADULTI (18+ ani) din documentul laboratorului sau null. IMPORTANT: daca exista mai multe intervale pe varste (copii, adolescenti, adulti), ia OBLIGATORIU doar intervalul pentru Adulti 18+ ani. Ignora complet intervalele pentru copii si adolescenti","tip_rezultat":"numeric sau calitativ","rezultat_text":"rezultatul text complet sau null","status":"normal sau peste sau sub sau negativ sau pozitiv sau necunoscut","data":"YYYY-MM-DD sau null"}],"laborator":"numele laboratorului sau null","oras_laborator":"orasul laboratorului sau null","tara_laborator":"tara laboratorului sau null","data_buletin":"YYYY-MM-DD sau null"}`
            }
          ]
        }]
      })
    ...
    const numeUnice=[...new Set((parsed.analize||[]).map((a: any)=>a.nume.toLowerCase().trim()))]
